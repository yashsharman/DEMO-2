...
function Footer() {
  return (
    <footer className="bg-[#1c180f] text-cream pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-2 space-y-8">
            ...
            <div className="flex gap-6">
              <a
                className="hover:text-primary transition-colors text-sm uppercase tracking-widest font-medium text-gray-300"
          ...
          <div>
            ...
            <form className="flex gap-2">
              <input
                className="bg-white/10 border-none placeholder:text-gray-300 rounded px-4 py-2 w-full text-sm focus:ring-1 focus:ring-primary"
        ...
        <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] uppercase tracking-[0.2em] text-gray-300">
